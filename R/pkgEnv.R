...
pkgEnv$varAliases <- list(
  ...
  loadFactor = c("clusters", "mcYears", "thermalModulation"),
  loadFactorLink = c("links", "FLOW LIN.", "linkCapacity"),
  netLoad = c("areas", "LOAD", "ROW BAL.", "PSP", "MISC. NDG",
              "H. ROR", "WIND", "SOLAR", "mustRun"),
  margins = c("areas", "clusters", "H. ROR", "WIND", "SOLAR", "MISC. NDG","LOAD", 
              "BALANCE", "hydroStorageMaxPower", "mustRun"),
  surplus = c("areas", "links", "mcYears", "LOAD", "MRG. PRICE", "OV. COST", 
              "CONG. FEE (ALG.)",
              "NUCLEAR", "LIGNITE", "COAL", "GAS", "OIL", "MIX. FUEL",
              "MISC. DTG", "H. STOR", "H. ROR", "WIND", "SOLAR",
              "MISC. NDG", "PSP", "ROW BAL."),
  surplusClusters = c("areas", "clusters", "mcYears", "MRG. PRICE", 
                      "thermalAvailabilities"),
  surplusSectors = c("areas", "clusters", "mcYears" ,"WIND", "SOLAR", "H. ROR", 
                     "H. STOR", "MRG. PRICE"),
