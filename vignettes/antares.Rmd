...
Let us consider the following antares study. It contains a network with 72 areas and 120 links representing the european network. Let assume that we want to visualize the problems of congestion: more precisely, we want to see the proportion of hour when each link was congestioned. 
...
To plot the network, we read the areas layout and add the coordinates of the origin and destination of each link.
...
# the areas
plot(layout$areas$x, layout$areas$y, type = "n", xaxt = "n", yaxt = "n", 
...
# Adding the areas
points(layout$areas$x, layout$areas$y, cex = 1.5, pch = 21, bg = "white")
