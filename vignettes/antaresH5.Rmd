...
With h5 file, ``antaresRead`` will be running faster. Your reading will take between **2 and 4 times** less time. An other avantage is the **compression**, a study can pass from **1.5Go** in txt to **230Mo** in h5. Furthermore, a h5 transformation convert lot of txt file in a single h5 file, it will be **easier to move** it. Finally, you can use in the same way function of ``antaresProcessing`` and ``antaresViz`` packages. You can also use ``addProcessingH5`` function to add columns to your h5 file.
